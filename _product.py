...
COMMON_SPECS = [
    ...
    ('Покупка', 'Способы оплаты', 'Картой онлайн, наличными, рассрочка 0-0-12, кредит'),
...
REVIEWS = [
    ...
    ('Патимат', '14 августа 2026', 5, 'Оформила в рассрочку, одобрили за пару минут. Консультант подробно '
...
{variants(prod, cat)}
        ...
        <div class="product__installment-row">
          ...
          <span>Рассрочка 0-0-12 — <b>{money(price / 12)}</b> в месяц, без переплаты</span>
        </div>
        ...
        <div class="delivery-list">
          ...
          <div class="delivery-row">
            ...
            <span class="delivery-row__text"><b>СДЭК по России</b> 2–5 дней, оплата онлайн</span>
